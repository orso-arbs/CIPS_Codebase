...
## Description: 
The Visit-Cellpose-Lineage Pipeline provides a quick way of analysing cellular structures in large data sets using VisIt and Cellpose.
...
- CP_extract - Combines the data from the previous two steps and deduce initial cell properties such as centroids, areas, diameters, and contour lengths.
- Analysis_Altantzis2011 - Orchestrates the following functions for the analysis for the specific case of the Altantzis (2011) numerical simulation data (DNS).
...
3. Install VisIt 3.4.2 December 2024 both on your machine and on your Euler /cluster/home/username:
...
4. Access Euler
   ...
   2. (Optional) In order not to enter the Euler password every time VisIt is lanched, you can set up a passwordless login with an SSH key. [Here](https://www.ssh.com/academy/ssh/putty/windows/puttygen) are tutorial videos.
...
2. Activate the Python environment
   1. Open a terminal and run:
      ...
      or using your IDE (for example, VScode) select cellpose_env_2
